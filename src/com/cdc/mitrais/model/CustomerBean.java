	...
	public List<CustomerBean> getAllCustomer(){
		...
		try {
			...
			while (resultSet.next()) {
				...
				customer.setChildren(resultSet.getInt("children"));
				customer.setFname(resultSet.getString("fname"));
				customer.setLname(resultSet.getString("lname"));
				customer.setMarried(resultSet.getString("married"));
				customer.setSmoker(resultSet.getString("smoker").trim().equals("Y") ? true : false );
				customerList.add(customer);				
				//logger.debug("FirstName:"+customer.getFname()+" LastName:"+customer.getLname());
				System.out.println("FirstName:"+customer.getFname()+" LastName:"+customer.getLname());
				
			}

		}catch(Exception e) {
			System.out.println("Error populating Customer Bean:"+e.toString());
